...
def parse_arguments():
    ...
    parser.add_argument("--feather_face_mask", type=int, default=2, choices=[0, 1, 2], help="0: classic binary box, 1: feathered binary box, 2: multi-step face features mask (MediaPipe)")

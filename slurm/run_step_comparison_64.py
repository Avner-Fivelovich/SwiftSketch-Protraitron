...
def main():
    ...
    output_comparison_dir = "data/step_comparison_64"
    ...
    print(f"Selected 6 images for 64-stroke step comparison:")
    for f in npz_files:
        print(f" - {f}")
    ...
    for idx, src_file in enumerate(npz_files):
        ...
        print(f"\n==========================================")
        print(f"Processing Image {idx+1}/6 (64 Strokes): {img_name}")
        print(f"==========================================")
        ...
        print(f"Running ControlSketch 64-stroke optimization for {img_name}...")
        result = subprocess.run(cmd, env=env)
        
        if result.returncode == 0:
            print(f"Successfully finished 64-stroke optimization for {img_name}!")
        else:
            print(f"Error occurred during 64-stroke optimization for {img_name}. Code: {result.returncode}")

    print("\n64-stroke comparison experiment completed! Check data/step_comparison_64/ for the results.")
